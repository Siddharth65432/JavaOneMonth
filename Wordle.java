...
public class Wordle {
    public static void main(String[] args) {
        ...
        System.out.println("\u001B[42mWelcome to the Wordle Game\u001B[0m");
        System.out.println("********************************************************************************************************");
        ...
        System.out.println("\u001B[43mIf the tile turns green, the letter is in the word, and it is in the correct spot.\u001B[0m");
        System.out.println("\u001B[45mIf the tile turns yellow, the letter is in the word, but it is not in the correct spot.\u001B[0m");
        System.out.println("\u001B[40mIf the tile turns gray, the letter is not in the word.\u001B[0m");
        System.out.println("********************************************************************************************************");
        System.out.println("\u001B[42mSelect difficulty:\u001B[0m");
        System.out.println("\u001B[41mEasy - 1\u001B[0m");
        System.out.println("\u001B[41mMedium - 2\u001B[0m");
    ...
    class GameBase {
        ...
        private final String[] fiveLetterWords = {"python", "serve", "blink", "trick", "hints"};
        private final String[] sixLetterWords = {"coding", "server", "walter", "rocket", "flight"};
        private final String[] sevenLetterWords = {"traffic", "package", "backend", "bravery", "weather"};
        ...
        private String getRandomWord(int wordLength) {
            ...
            switch (wordLength) {
                case 5:
                    selectedArray = fiveLetterWords;
                    break;
                case 6:
                    selectedArray = sixLetterWords;
                    break;
                case 7:
                    selectedArray = sevenLetterWords;
                    break;
                default:
                    selectedArray = fiveLetterWords;
                    break;
